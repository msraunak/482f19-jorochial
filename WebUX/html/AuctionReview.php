  ...
  <body>
    ...
    <nav class="navbar navbar-light navbar-expand-lg bg-light" >
      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <form class="form-inline"><!--TODO: Add functionality to Search bar -->
...
<h2 class="text-center">Below is a selection of auctions, past, ongoing, and queued up:</h2>
<br><br>
...
<div class="card mb-3 col" >
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Auction 1 (Closed)</h5>
...
<div class="card mb-3 col" >
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Auction 2 (Closed)</h5>
        <p class="card-text">This chessboard was owned by King George back in 1945, seeing use by over three generation sof royal family....</p>
        <p class="card-text"><small class>Current Bid: $1,000.00</small></p>
        <p class="card-text"><small class="text-muted">Donated by: The Royal Family</small></p>
        <a href="#" class="btn stretched-link"></a>
...
<div class="card mb-3 col" >
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Auction 3 (Ongoing)</h5>
        <p class="card-text">This chessboard was owned by King Percival of Belgium back in 1967....</p>
        <p class="card-text"><small class>Current Bid: $5,000.00</small></p>
        <p class="card-text"><small class="text-muted">Donated by: The Belgium Government</small></p>
        <a href="#" class="btn stretched-link"></a>
      </div>
    </div>
  </div>
...
<div class="card mb-3 col" >
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Auction 4 (Preview)</h5>
        <p class="card-text">Benefitting the Shriners association of America</p>
        <a href="#" class="btn stretched-link"></a>
      </div>
    </div>
  </div>
