...
function donorRow($orgName, $auctionName, $repName, $phoneNum, $email, $address) {
...
function donorTable($pageNum,$tableSize ,$mysqli){
  ...
  while( $row = $result->fetch_assoc( ) ){
     $htmlResult .= donorRow($row['orgName'],$row['auctionName'],$row['repName'], $row['phoneNum'], $row['email'], $row['address']);
  }
  return $htmlResult;
}
